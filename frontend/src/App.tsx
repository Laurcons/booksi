...
export default function App() {
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <LocaleProvider>
        {/* §D51 — inside `LocaleProvider`, because a toast is a sentence and
            has to be in the reader's language; outside the router, because the
            author messages fire from a dialog that any route may have open. */}
        <ToastProvider>
          <BrowserRouter>
            <Routes>
